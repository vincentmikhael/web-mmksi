    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                ...
                <div>Last updated by {{$sparepart->updated_by}}</div>
            </div>
            <div class="card-body">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" class="form-control" value="{{$sparepart->text1}}" name="text1">
                    <label for="">Sub Text</label>
                    <input type="text" class="form-control" value="{{$sparepart->text2}}" name="text2">
