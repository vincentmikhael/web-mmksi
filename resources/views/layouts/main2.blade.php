...
<body>
    ...
    <nav style="border-bottom: 3px solid #D81324" class="navbar navbar-expand-lg bg-dark navbar-dark shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 me-5 p-lg-0">
    ...
    <div class="fixed-bottom">
        <div class="container bg-dark py-3 wrapper-bottom d-flex justify-content-around align-items-center">
            <a href="/dealer" style="font-size: 15px;" class="text-white text-nav-bottom d-flex align-items-center gap-2 flex-column flex-md-row"> <i class="fas fa-map-marker-alt"></i> Cari Dealer</a>
            <a href="/list-brosur" style="font-size: 15px;" class="text-white text-nav-bottom d-flex align-items-center gap-2 flex-column flex-md-row"><i class="fas fa-download"></i>Download Brosur</a>
            <a href="/test-drive" style="font-size: 15px;" class="text-white text-nav-bottom d-flex align-items-center gap-2 flex-column flex-md-row"><i class="fas fa-car"></i>Test Drive</a>
            <a href="/#carousel-kendaraan" style="font-size: 15px;" class="text-white text-nav-bottom d-flex align-items-center gap-2 flex-column flex-md-row"><i class="fas fa-list"></i>Price List</a>
        </div>
    </div>
    <!-- Footer Start -->
